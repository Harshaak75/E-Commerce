...
function NavbarBuyer() {
    ...
    return (
        <div>
            ...
            <div className="navbar flex items-center px-5 text-lg font-semibold font-manrope justify-between h-12 pt-5">
                
                <h1>MAVEX</h1>
                <h1 className='pl-28'>MENU</h1>
                <div className="left-nav flex gap-4">
                    <div className="">
                        <Link to={"/CreateSellerAccount"}><h1 className='seller'>Become a Seller</h1></Link>
